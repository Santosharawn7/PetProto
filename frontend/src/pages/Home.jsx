...
const Home = ({ showSearchModal, setShowSearchModal }) => {
  ...
  const sortedMatches = matches
    .filter((u) => {
      ...
      if (
        petNameQuery &&
        !p.name?.toLowerCase().includes(petNameQuery.toLowerCase())
      )
        return false;
      return true;
    })
        ...
        <div className="flex justify-center items-center min-h-[60vh]">
          <div className="text-center bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              To start finding matches for your pet, you need to create a pet
              profile first.
            </p>
            <button
              ...
              {sortedMatches.length > 0 ? (
                ...
                <div className="text-center bg-white rounded-lg shadow-lg p-8">
                  ...
                  <p className="text-gray-500">
                    Try adjusting your filters to find more matches for your
                    pet.
                  </p>
                </div>
              )}
