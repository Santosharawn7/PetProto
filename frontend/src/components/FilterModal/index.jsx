...
const FilterModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      {/* Single blurred background overlay */}
      <div
        className="absolute inset-0 bg-black/50 backdrop-blur-sm"
        onClick={onClose}
      />

      {/* Modal content - directly embedded, no nested components */}
      <div className="relative z-10 p-6 bg-white rounded-xl shadow-2xl max-w-lg w-full mx-4">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        {/* Single Apply Filters Button */}
        <button 
          onClick={onClose}
          className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 shadow-lg"
        >
          Apply Filters
        </button>
      </div>
