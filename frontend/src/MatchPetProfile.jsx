  ...
  if (!match) {
    return (
      <div className="p-6 text-center">
        ...
        <button onClick={()=>navigate('/home')} className="mt-4 px-4 py-2 bg-blue-600 text-white rounded">
          Back to Home
        </button>
      </div>
    );
    ...
    <div className="p-6 flex justify-center">
      <div className="max-w-md w-full bg-white rounded-2xl shadow overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="mt-4 text-lg font-semibold">Score: {match.petMatchScore}</p>
          <button
